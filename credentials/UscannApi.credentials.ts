...
export class UscannApi implements ICredentialType {
	name = 'N8nDevUscannApi';

	displayName = 'uscann API';

	icon: Icon = { light: 'file:../nodes/Uscann/uscann.svg', dark: 'file:../nodes/Uscann/uscann.dark.svg' };
	...
	properties: INodeProperties[] = [
		{
			...
			description: 'The base URL of your uscann API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
